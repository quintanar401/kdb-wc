...
(function() {
  var _KDBChart, _KDBEditor, _KDBQuery, _KDBSrv, _KDBTable, copyCfg, extractInfo, getConfig, keval, mergeCfgs,
  ...
  _KDBQuery = (function(superClass) {
    ...
    _KDBQuery.prototype.setupQuery = function() {
      var el, j, len, prvExec, ref, ref1, ref10, ref11, ref12, ref13, ref14, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, v;
      prvExec = this.exec;
      if (this.ktimer) {
      ...
      this.kInterval = ((ref8 = this.attributes['k-interval']) != null ? ref8.textContent : void 0) || "0";
      this.kInterval = Number.parseInt ? Number.parseInt(this.kInterval) : Number(this.kInterval);
      this.kDelay = ((ref9 = this.attributes['k-delay']) != null ? ref9.textContent : void 0) || "0";
      this.kDelay = Number.parseInt ? Number.parseInt(this.kDelay) : Number(this.kDelay);
      this.kQStatus = ((ref10 = this.attributes['k-status-var']) != null ? ref10.textContent : void 0) || null;
      this.kQNum = 0;
      if (this.kFilter = (ref11 = this.attributes['k-filter']) != null ? ref11.textContent : void 0) {
        this.kFilter = keval(this.kFilter);
      }
      this.result = null;
      if (indexOf.call(this.exec, 'load') >= 0 && (!prvExec || !(indexOf.call(prvExec, 'load') >= 0))) {
        if ((ref12 = document.readyState) === 'complete' || ref12 === 'interactive') {
      ...
      this.kRefs = (ref14 = this.query.match(/\$(\w|\.)(\w|\.|\]|\[)*\$/g)) != null ? ref14.map(function(e) {
    ...
    _KDBQuery.prototype.updateStatus = function() {
      var a, error1;
      if (this.kQStatus) {
        a = new Function("x", this.kQStatus + " = x; console.log(x);");
        try {
          a(this.kQNum);
        } catch (error1) {
          null;
    ...
    _KDBQuery.prototype.updateObj = function(n, isUpd, o) {
      var a, e, err, error1, error2, i, j, len, opt, r, ref, ref1, ref2, results, s, ty;
  ...
  _KDBTable = (function(superClass) {
    ...
    _KDBTable.prototype.createdCallback = function() {
      var cont, kClass, kStyle, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8;
      ...
      kClass = ((ref6 = this.attributes['k-class']) != null ? ref6.textContent : void 0) || "";
      kStyle = ((ref7 = this.attributes['k-style']) != null ? ref7.textContent : void 0) || "";
  ...
  _KDBEditor = (function(superClass) {
    ...
    _KDBEditor.prototype.kdbUpd = function(r) {
      ...
      if (typeof r === 'string' || Array.isArray(r)) {
        ...
        this.kEditor.gotoLine(0, 0, false);
      }
      if (cfg) {
        if ((cfg.row != null) || (cfg.column != null)) {
          this.kEditor.gotoLine(cfg.row || 0, cfg.column || 0, false);
        }
        if (cfg.markers != null) {
          if (this.kMarkers) {
            ref2 = this.kMarkers;
